...
export const api = {
  auth: {
    register: (data: { name: string; email: string; password: string; password_confirmation: string; phone?: string; role?: string; store_name?: string; business_name?: string; payment_number?: string; payment_provider?: string }) =>

      ...
      <section className="relative overflow-hidden bg-[#111111] px-4 pb-12 pt-36 text-white sm:px-6 lg:px-8 lg:pb-24 lg:pt-44">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:gap-3">
            <MagneticButton to="/plans" variant="light" className="min-h-12 w-full justify-center px-7 py-4 sm:w-auto">View plans</MagneticButton>
      ...
      <section className="bg-[#111111] px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <MagneticButton to="/plans" variant="light" className="min-h-12 px-8 py-4">View plans</MagneticButton>

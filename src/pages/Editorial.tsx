      ...
      <section className="relative overflow-hidden bg-[#14171F] px-4 pb-12 pt-36 text-white sm:px-6 lg:px-8 lg:pb-24 lg:pt-44">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:gap-4">
            <MagneticButton to="/shop" variant="gold" className="min-h-12 w-full justify-center px-6 py-3 text-sm sm:w-auto" onClick={() => {}}>Shop the edit</MagneticButton>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div data-reveal className="grid overflow-hidden rounded-[2.8rem] border border-black/[0.08] bg-[#FAF9F5] shadow-[0_30px_110px_rgba(0,0,0,0.08)] lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="flex flex-col justify-center p-6 sm:p-12">
              <p className="text-xs font-black uppercase tracking-[0.32em] text-[#2C5A82]">{featuredStore.category} Â· {featuredStore.location}</p>
      ...
      <section className="overflow-x-hidden bg-[#14171F] px-4 py-12 text-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <div className="mt-8 flex justify-center">
            <MagneticButton to="/contact" variant="gold" className="min-h-12 px-6 py-3 text-sm">Get the edit</MagneticButton>
          </div>
        </div>
      </section>
    </div>

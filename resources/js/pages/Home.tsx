            ...
            return (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 text-white sm:p-4 lg:p-6">
                  <p className="mb-1 text-[0.45rem] font-bold uppercase tracking-[0.15em] text-[#2C5A82] sm:mb-3 sm:text-xs sm:tracking-[0.34em]">0{index + 1} · {category.count} pieces</p>
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <SectionHeader
            ...
            title={<>Flash <span className="font-editorial text-[#2C5A82]">sales</span> — hurry!</>}
            className="max-w-lg"
          />
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-3 flex items-center gap-2">
          ...
          {product.originalPrice ? (
            <span className="text-sm text-[#909090] line-through">{product.originalPrice.toLocaleString()} RWF</span>
          ) : null}
        </div>

  ...
  return (
    <div className="overflow-x-hidden bg-[#F8F9FA]">
      ...
      <section className="relative overflow-hidden bg-[#111111] px-4 pb-16 pt-36 text-white sm:px-6 lg:px-8 lg:pb-20 lg:pt-44">
        ...
        <div aria-hidden className="luxury-orb left-[8%] top-[25%] h-80 w-80 bg-[#5BA3CF]/15" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="mt-4 max-w-5xl font-display text-[clamp(1.5rem,7vw,9rem)] font-black uppercase leading-[0.82] tracking-[-0.08em] sm:mt-6">
            Why <span className="font-editorial normal-case text-[#5BA3CF]">GIHANGA</span>
          </h1>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center" data-reveal>
            <p className="text-xs font-black uppercase tracking-[0.32em] text-[#5BA3CF]">Benefits</p>
            <h2 className="mt-4 font-display text-[clamp(1.5rem,4.5vw,4.6rem)] font-black leading-[0.95] tracking-[-0.05em]">Everything your boutique <span className="font-editorial text-[#5BA3CF]">needs</span></h2>
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {benefits.map((b) => (
              <article key={b.title} data-reveal className="group rounded-[2.4rem] border border-black/[0.08] bg-white p-8 shadow-[0_20px_70px_rgba(0,0,0,0.05)] transition hover:-translate-y-1 hover:shadow-[0_30px_90px_rgba(0,0,0,0.08)]">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#111111] text-[#5BA3CF] transition group-hover:rotate-3 group-hover:scale-110">
      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center" data-reveal>
            <p className="text-xs font-black uppercase tracking-[0.32em] text-[#5BA3CF]">Kigali-first</p>
            <h2 className="mt-4 font-display text-[clamp(1.5rem,4.5vw,4.6rem)] font-black leading-[0.95] tracking-[-0.05em]">Built for <span className="font-editorial text-[#5BA3CF]">Kigali</span></h2>
          ...
          <div className="mt-14 grid grid-cols-1 gap-5 text-center sm:grid-cols-3" data-reveal>
            <div className="rounded-[2rem] border border-black/[0.08] bg-[#F8F9FA] p-8">
              <p className="font-editorial text-5xl text-[#5BA3CF]">30+</p>
            ...
            <div className="rounded-[2rem] border border-black/[0.08] bg-[#F8F9FA] p-8">
              <p className="font-editorial text-5xl text-[#5BA3CF]">1 hr</p>
            ...
            <div className="rounded-[2rem] border border-black/[0.08] bg-[#F8F9FA] p-8">
              <p className="font-editorial text-5xl text-[#5BA3CF]">100%</p>
      ...
      <section className="bg-[#111111] px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-3xl">
          <h2 className="font-display text-[clamp(2rem,5vw,4.5rem)] font-black leading-[0.9] tracking-[-0.06em] text-white">
            Ready to join <span className="font-editorial text-[#5BA3CF]">GIHANGA</span>?
          </h2>

      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center" data-reveal>
            ...
            <p className="mt-5 text-base leading-7 text-[#6D6D6D]">From storefront to delivery — we handle the platform so you can focus on fashion.</p>
          </div>
      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center" data-reveal>
            ...
            <p className="mt-6 text-base leading-7 text-[#6D6D6D] mx-auto max-w-2xl">
          ...
          <div className="mt-14 grid grid-cols-1 gap-5 text-center sm:grid-cols-3" data-reveal>
            <div className="rounded-[2rem] border border-black/[0.08] bg-[#FAF9F5] p-8">
              ...
              <p className="mt-1 text-sm text-[#6D6D6D]">Verified sellers across Kigali</p>
            </div>
            <div className="rounded-[2rem] border border-black/[0.08] bg-[#FAF9F5] p-8">
              <p className="font-editorial text-5xl text-[#2C5A82]">1 hr</p>
              <p className="mt-3 font-display text-lg font-black">Delivery</p>
              <p className="mt-1 text-sm text-[#6D6D6D]">Average drop‑off time in Kigali</p>
            </div>
            <div className="rounded-[2rem] border border-black/[0.08] bg-[#FAF9F5] p-8">
              <p className="font-editorial text-5xl text-[#2C5A82]">100%</p>
              <p className="mt-3 font-display text-lg font-black">Verified</p>
              <p className="mt-1 text-sm text-[#6D6D6D]">Every boutique goes through identity verification</p>
            </div>
          </div>
        </div>
      </section>

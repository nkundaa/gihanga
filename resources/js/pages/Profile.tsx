      ...
      <div className="overflow-x-hidden bg-[#F8F9FA] pt-24 lg:pt-28">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] border border-dashed border-black/10 bg-white/60 px-6 py-16 text-center">
            ...
            <MagneticButton to="/login" variant="berry" className="mt-6 min-h-12 px-6 py-3 text-sm">Sign in</MagneticButton>
          </div>
        </div>
      </div>
    );
        ...
        <div className="space-y-8">
          <section className="rounded-[2rem] border border-black/[0.08] bg-white p-6 shadow-[0_20px_70px_rgba(0,0,0,0.06)] sm:p-8">
            <div className="flex items-center gap-3">
              <UserIcon className="h-5 w-5 text-[#BFD7F1]" />
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
                ...
                <input value={name} onChange={(e) => setName(e.target.value)} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" />
              </div>
              <div>
              ...
              <div>
                ...
                <input value={phone} onChange={(e) => setPhone(e.target.value)} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" placeholder="+250 788 000 000" />
              </div>
            </div>
            ...
            <MagneticButton variant="berry" className="mt-6 min-h-12 px-6 py-3 text-sm" onClick={saveProfile} disabled={saving}>
          ...
          <section className="rounded-[2rem] border border-black/[0.08] bg-white p-6 shadow-[0_20px_70px_rgba(0,0,0,0.06)] sm:p-8">
            <div className="flex items-center gap-3">
              <Lock className="h-5 w-5 text-[#BFD7F1]" />
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
                ...
                <input type="password" value={pwCurrent} onChange={(e) => setPwCurrent(e.target.value)} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" />
              </div>
              <div>
                <label className="mb-2 block text-xs font-black uppercase tracking-[0.28em] text-[#666666]">New password</label>
                <input type="password" value={pwNew} onChange={(e) => setPwNew(e.target.value)} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" />
              </div>
              <div>
                <label className="mb-2 block text-xs font-black uppercase tracking-[0.28em] text-[#666666]">Confirm new password</label>
                <input type="password" value={pwConfirm} onChange={(e) => setPwConfirm(e.target.value)} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" />
              </div>
            </div>
            ...
            <MagneticButton variant="dark" className="mt-6 min-h-12 px-6 py-3 text-sm" onClick={savePassword} disabled={pwSaving}>
          ...
          <section className="rounded-[2rem] border border-black/[0.08] bg-white p-6 shadow-[0_20px_70px_rgba(0,0,0,0.06)] sm:p-8">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <MapPin className="h-5 w-5 text-[#BFD7F1]" />
            ...
            {loadingAddresses ? (
              <div className="mt-6 flex justify-center py-8">
                <div className="h-6 w-6 animate-spin rounded-full border-2 border-[#BFD7F1] border-t-transparent" />
              </div>
                  ...
                  <div key={addr.id} className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-black/[0.06] bg-[#F8F9FA] p-4">
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {addr.is_default ? <span className="rounded-full bg-[#BFD7F1] px-2 py-0.5 text-[0.5rem] font-bold uppercase tracking-[0.15em]">Default</span> : null}
                      </div>
            ...
            {showAddressForm ? (
              <div className="mt-6 rounded-2xl border border-[#BFD7F1] bg-[#BFD7F1]/5 p-5">
                <p className="text-xs font-black uppercase tracking-[0.28em] text-[#BFD7F1]">{editingAddress ? "Edit" : "New"} address</p>
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  <div>
                    <label className="mb-2 block text-xs font-black uppercase tracking-[0.28em] text-[#666666]">Label</label>
                    <input value={addrForm.label} onChange={(e) => setAddrForm({ ...addrForm, label: e.target.value })} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" placeholder="Home, Office, etc." />
                  </div>
                  <div>
                    <label className="mb-2 block text-xs font-black uppercase tracking-[0.28em] text-[#666666]">Phone</label>
                    <input value={addrForm.phone} onChange={(e) => setAddrForm({ ...addrForm, phone: e.target.value })} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" />
                  </div>
                  <div className="sm:col-span-2">
                    <label className="mb-2 block text-xs font-black uppercase tracking-[0.28em] text-[#666666]">Address</label>
                    <input value={addrForm.address} onChange={(e) => setAddrForm({ ...addrForm, address: e.target.value })} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" />
                  </div>
                  <div>
                    <label className="mb-2 block text-xs font-black uppercase tracking-[0.28em] text-[#666666]">City</label>
                    <input value={addrForm.city} onChange={(e) => setAddrForm({ ...addrForm, city: e.target.value })} className="min-h-12 w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none transition focus:border-[#BFD7F1]" />
                  </div>
                ...
                <div className="mt-4 flex gap-3">
                  <MagneticButton variant="berry" className="min-h-11 px-5 py-2 text-xs" onClick={saveAddress} disabled={addrSaving}>

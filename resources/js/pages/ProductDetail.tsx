      ...
      <div className="mx-auto mt-8 grid max-w-7xl gap-6 px-4 pb-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:pb-24">
        ...
        <div data-reveal className="lg:sticky lg:top-28 lg:self-start">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm">
            <span className="inline-flex items-center gap-1 font-bold"><Star className="h-4 w-4 fill-[#2C5A82] text-[#2C5A82]" /> {product.rating.toFixed(1)} · {product.reviews} reviews</span>
          ...
          {product.colors && product.colors.length > 0 ? (() => {
            ...
            return (
              <div className="mt-4">
                <p className="text-xs font-black uppercase tracking-[0.28em] text-[#6D6D6D]">Color · {selected}</p>
          ...
          <div className="mt-4 flex flex-col gap-3 sm:mt-8 sm:flex-row">
            <MagneticButton variant="gold" className="min-h-12 w-full justify-center px-5 py-3 text-sm sm:flex-1" onClick={() => addItem(product, { size, color })}>
              Add to bag
            </MagneticButton>
            <MagneticButton variant="primary" className="min-h-12 w-full justify-center px-5 py-3 text-sm sm:flex-1" onClick={() => addItem(product, { size, color })}>
              Buy now
            </MagneticButton>
          </div>
          ...
          <ul className="mt-8 grid gap-3 border-t border-black/10 pt-6 text-sm">
            ...
            <li className="flex items-center gap-3"><Truck className="h-5 w-5 shrink-0 text-[#2C5A82]" /> Kigali delivery in 24–48 hours</li>

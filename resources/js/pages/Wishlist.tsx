    ...
    <div className="overflow-x-hidden bg-[#F8F9FA]">
      ...
      <section className="relative flex min-h-[25svh] items-center overflow-hidden bg-[#111111] py-10 text-white sm:py-12 sm:min-h-[30svh] pt-28">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {count > 0 ? (
            <button type="button" onClick={clearWishlist} className="mt-3 min-h-11 text-[0.6rem] font-bold uppercase tracking-[0.18em] text-[#BFD7F1] underline-grow sm:mt-4 sm:text-xs sm:tracking-[0.2em]">
              Clear wishlist
            </button>
          ) : null}
        </div>
        ...
        <section className="overflow-x-hidden bg-white px-4 py-16 sm:px-6 lg:px-8 sm:py-20">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <div className="mt-8 flex justify-center gap-3">
              <MagneticButton to="/shop" variant="dark" className="min-h-12 px-6 py-3 text-sm">Continue shopping</MagneticButton>
            </div>
          </div>
        </section>
      ) : null}

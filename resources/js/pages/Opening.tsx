        ...
        <div className="grid w-full gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-12">
          <div className="max-w-3xl">
            ...
            <motion.div className="mt-4 flex flex-col gap-2 sm:mt-10 sm:flex-row sm:flex-wrap sm:gap-4"
              ...
              <Button to="/shop" variant="primary" className="w-full justify-center px-4 py-3 text-xs min-h-12 sm:w-auto sm:px-6 sm:py-4 sm:text-sm">
                Shop Now
              </Button>
              <Button to="/shop" variant="ghost" className="w-full justify-center px-4 py-3 text-xs min-h-12 sm:w-auto sm:px-6 sm:py-4 sm:text-sm">
                Explore Products
              </Button>
            </motion.div>
          </div>

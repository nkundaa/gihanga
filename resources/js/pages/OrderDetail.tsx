    ...
    return (
      <div className="overflow-x-hidden bg-[#F8F9FA] pt-24 lg:pt-28">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <EmptyState title="Order not found" copy="This order may have been removed or doesn't exist." action={<MagneticButton to="/dashboard" variant="berry" className="min-h-12 px-6 py-3 text-sm">Back to dashboard</MagneticButton>} />
        </div>
      </div>
    );
  }
      ...
      <div className="mx-auto max-w-4xl px-4 pb-24 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.36em] text-[#BFD7F1]">Order</p>
        ...
        {isCancelled ? (
          ...
          <div className="mb-8 rounded-[2rem] border border-black/[0.08] bg-white p-6 shadow-[0_12px_40px_rgba(0,0,0,0.04)] sm:p-8">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#BFD7F1]">Tracking</p>
                ...
                {statusSteps.map((step, i) => {
                  ...
                  return (
                    <div key={step.key} className="flex flex-col items-center">
                      <div className={cn("flex h-10 w-10 items-center justify-center rounded-full transition", isActive ? "bg-[#111111] text-[#BFD7F1]" : "bg-[#F8F9FA] text-[#666666]")}>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <section className="rounded-[2rem] border border-black/[0.08] bg-white p-6 shadow-[0_12px_40px_rgba(0,0,0,0.04)] sm:p-8">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#BFD7F1]">Delivery</p>
            <div className="mt-4 space-y-3">
              <div className="flex items-center gap-3">
                <MapPin className="h-4 w-4 shrink-0 text-[#BFD7F1]" />
                <div>
              ...
              <div className="flex items-center gap-3">
                <Phone className="h-4 w-4 shrink-0 text-[#BFD7F1]" />
          ...
          <section className="rounded-[2rem] border border-black/[0.08] bg-white p-6 shadow-[0_12px_40px_rgba(0,0,0,0.04)] sm:p-8">
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-center gap-3">
                <CreditCard className="h-4 w-4 shrink-0 text-[#BFD7F1]" />
                <p className="text-sm font-bold capitalize">{order.payment?.replace("_", " ") ?? "N/A"}</p>
              </div>
              <div className="flex items-center gap-3">
                <Truck className="h-4 w-4 shrink-0 text-[#BFD7F1]" />
        ...
        <section className="mt-6 rounded-[2rem] border border-black/[0.08] bg-white p-6 shadow-[0_12px_40px_rgba(0,0,0,0.04)] sm:p-8">
          <p className="text-xs font-black uppercase tracking-[0.28em] text-[#BFD7F1]">Items</p>
          <div className="mt-4 space-y-3">

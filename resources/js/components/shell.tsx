...
export function Navigation() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 px-2 py-3 sm:px-4 sm:py-4 lg:px-8">
      <nav
      ...
      >
        ...
        <div className="flex items-center gap-1 sm:gap-2 sm:gap-3">
          ...
          >
            ...
            {wishlistCount > 0 ? (
              <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-[#FFD5EA] px-1 text-[0.5rem] font-black text-[#111111] sm:h-5 sm:min-w-5 sm:text-[0.65rem]">
                {wishlistCount}
              </span>
            ) : null}
          </Link>
          ...
          >
            ...
            {count > 0 ? (
              <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-[#BFD7F1] px-1 text-[0.5rem] font-black text-[#111111] sm:h-5 sm:min-w-5 sm:text-[0.65rem]">
                {count}
              </span>
            ) : null}
          </button>
          ...
          <MagneticButton to="/shop" variant="dark" className="hidden px-4 py-2.5 text-xs sm:inline-flex sm:px-5 sm:py-3 sm:text-sm">
            Shop Now
          </MagneticButton>
          <button
            type="button"
